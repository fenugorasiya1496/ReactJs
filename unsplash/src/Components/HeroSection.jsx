            ...
            {/* Text And Btn */}
                <div className='w-1/2 flex flex-col justify-end items-start gap-y-25'>
                    ...
                    <div>
                        ...
                        <p className='text-[15px] font-semibold text-[#767676] my-2 leading-normal'>
                            Premium downloads
                            <br />
                    ...
                    <button className='text-[14px] font-medium text-white bg-black px-3 py-1 rounded-lg '>Grt Unsplash+</button>
                </div>
            {/* Image And Chip */}
                <div className='relative  w-1/2'>
                    <img src="https://unsplash-assets.imgix.net/modules/legal-protections/photo-1.jpg?w=192&dpr=1&h=257&auto=format&fit=crop&q=60" alt="Image1" className='-rotate-6 '/>
                    <img src="https://unsplash-assets.imgix.net/modules/legal-protections/photo-2.jpg?w=192&dpr=1&h=257&auto=format&fit=crop&q=60" alt="Image2" className='absolute top-0  rotate-10 left-6' />
                    {/* Chip1 */}
                    <div className='flex items-center justify-center gap-x-1 absolute z-10 top-32  left-18 border border-gray-200 rounded-full px-2 py-1 bg-white font-normal text-[12px]'><CircleCheck fill='green' className='text-white w-5 h-5 '/>
                         Worry-free Licensing
                    </div>


                    {/* Chip2 */}
                    <div className='flex items-center justify-center gap-x-4 absolute z-10 text-[12px] bg-white border border-gray-200 px-2 py-1 rounded-full top-44 -left-6 '><CircleCheck fill='green' className='text-white w-5 h-5 '/>
